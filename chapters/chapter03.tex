...
\begin{figure}[H]
	\centering
	\subfloat[原始频率能量曲线]{\includegraphics[width=0.4\textwidth]{figures/othr/before_fft}%
		\label{fig:before_fft}}
	\hfil
	\subfloat[经过FFT变换的频率能量曲线]{\includegraphics[width=0.4\textwidth]{figures/othr/after_fft}%
		\label{fig:after_fft}}
...
\begin{figure}[H]
	\centering
	\subfloat[地杂波被错误识别为海杂波]{\includegraphics[width=0.4\textwidth]{figures/othr/error_land}%
		\label{fig:error_land}}
	\hfil
	\subfloat[海杂波被错误识别为地杂波]{\includegraphics[width=0.4\textwidth]{figures/othr/error_sea}%
		\label{fig:error_sea}}
	\caption{识别错误的结果}
