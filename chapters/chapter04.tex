...
本章利用了来自13架民航飞机的气象雷达辐射源的数据，飞机信息参见下表
\begin{table}[H]
	\renewcommand{\arraystretch}{1.3}
	\caption{辐射源信号数据}
	% \label{tab:nb_classes}\textit{}
	\centering
...
% 对于本章这个Open Set 识别问题，我们需要用别的参数衡量识别的准确度。利用文\cite{scheirer2013toward}中提出的通过训练类别的个数和测试类别的个数来描述数据集的开放度（openness），如公式\ref{equ:openness}所示
% \begin{equation}
